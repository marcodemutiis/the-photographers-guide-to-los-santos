...
Script Hook has native functions to create a fead to/from black. The function hash are ```DO_SCREEN_FADE_OUT``` and ```DO_SCREEN_FADE_OUT``` and they are followed by the number of milliseconds to go from full black to showing the scene and viceversa.
