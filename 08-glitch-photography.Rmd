    ...
    public class ModdingTutorial : Script    
    {
	    ...
	    private void onKeyDown(object sender, KeyEventArgs e)
	    {
	    	if (e.KeyCode == Keys.U)
			{
				...
				//set zero gravity
				Function.Call(Hash.SET_ENTITY_HAS_GRAVITY, Game.Player.Character, false);
				//teleport in the sky
				Function.Call(Hash.SET_ENTITY_COORDS, Game.Player.Character, Game.Player.Character.Position[0], Game.Player.Character.Position[1], Game.Player.Character.Position[2]+50, 0, 0, 1);
				Vector3 myPosition = Game.Player.Character.Position;
	    	}
	    	if(e.KeyCode == Keys.I)
	    	{
				Function.Call(Hash.SET_ENTITY_COORDS, Game.Player.Character, Game.Player.Character.Position[0], Game.Player.Character.Position[1], Game.Player.Character.Position[2]-50, 0, 0, 1);
