...
+ With the ```Select objects``` tool and ```Move``` tool selected, hold ```Shift``` and move the object to multiply the object.  In this example we have multiplied a chair a few times, moved them and rotated them.
...
This tutorial was adapted from [GTA 5 Tutorial - Part 2] Using codewalker and creating/modifying ymaps by [Tobii](https://www.youtube.com/watch?v=VDoAjV3kv2g&list=PL3KgAhmoIEOU540c5hydM5KaVXeJcYiPF&ab_channel=Tobii) and https://www.youtube.com/watch?v=70ODCkbrj60&ab_channel=TeachingHub
...
//Download and setup https://github.com/dexyfex/CodeWalker
