...
CodeWalker is an applicaiton that renders an interactive 3D Map for GTAV. Through CodeWalker we are able to modify the architecture and objects inside the map, replacing textures and images with custom content. 
...
```{r fig.align='left', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html')}
knitr::include_graphics('assets/CodeWalker.png', dpi = NA)
```
...
//add ymap to GTA 5 single player https://www.youtube.com/watch?v=ie9IgNyzB1M&ab_channel=RIBSOSAY
...
//Now go to Open IV > mods > update > update.rpf > common > data. Find dlclist.xml, richt click on it and choose edit. Scroll to the end of the file and add ```xml<Item>dlcpacks:/custom_maps/</Item> above </Paths>```.
...
//Inside that you'll copy the content of https://www.youtube.com/watch?v=70ODCkbrj60&ab_channel=TeachingHub
