...
+ In the Code Walker menu on the right go to ```Selection``` and check the filename of the object that contains our image. In our case that is "sp1_04_ground". This is the name of the .ydr file that contains the map model. 
