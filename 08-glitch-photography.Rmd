...
+ In order to install the Menyoo Single Player Trainer go to [github.com/MAFINS/MenyooSP/releases](https://github.com/MAFINS/MenyooSP/releases) and download the ```MenyooSP.zip``` file in the Assets section of the page. Open its content and select the ```menyooStuff``folder and ```Menyoo.asi```file.  Copy and paste these in your GTA V directory ```C:\Program Files (x86)\Steam\steamapps\common\Grand Theft Auto V```.

+ Run GTA V and press ```F8``` to bring up the Menyoo Trainer menu. From there you can control many of the functions we are learning to script, including character models, animations, and teleporting. Scripting will always give you more accurate control of what you can achieve, but a trainer mod is very useful in showing the possibilities. Finally, menyoo as a creative tool can be combined with custom scripts, Scene Director and Rockstar Editor. 
