...
//Now go to Open IV > mods > update > update.rpf > common > data. Find dlclist.xml, richt click on it and choose edit. Scroll to the end of the file and add <Item>dlcpacks:/custom_maps/</Item> above </Paths>.
