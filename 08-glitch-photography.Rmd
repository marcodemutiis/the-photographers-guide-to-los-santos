...
We can use the native function ```START_PLAYER_SWITCH``` to enable the satellite view animation from the game, and get transported to a different location where an NPC or player avatar is spawned.
