...
We can use the native function \texttt{START\_PLAYER\_SWITCH} to enable the satellite view animation from the game, and get transported to a different location where an NPC or player avatar is spawned.
