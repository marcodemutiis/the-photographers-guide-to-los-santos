...
On windows there are several ways to take a screenshot. To capture your entire screen and automatically save the screenshot, press the \texttt{Windows\ logo\ key} + \texttt{PrtScn\ key}, or alternatively \texttt{fn\ key} + \texttt{Windows\ logo\ key} + \texttt{PrtScn\ key}. The screenshot will be saved to the \texttt{Pictures\ \textgreater{}\ Screenshots\ folder}.
