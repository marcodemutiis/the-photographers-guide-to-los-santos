...
In this example, turn on the free camera by pressing \texttt{O} and then start and stop the recording of the camera movement by pressing \texttt{I}. To toggle the replay camera press \texttt{K}. Try changing color effects or adding objects and NPCs to the scene, while you move again your camera in the exact same path.
