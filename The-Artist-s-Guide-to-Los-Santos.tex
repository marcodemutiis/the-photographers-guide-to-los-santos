...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{myPeds[}\DecValTok{0}\NormalTok{].}\FunctionTok{Task}\NormalTok{.}\FunctionTok{Delete}\NormalTok{();}
\NormalTok{myPeds[}\DecValTok{1}\NormalTok{].}\FunctionTok{Task}\NormalTok{.}\FunctionTok{Delete}\NormalTok{();}
\NormalTok{myPeds[}\DecValTok{2}\NormalTok{].}\FunctionTok{Task}\NormalTok{.}\FunctionTok{Delete}\NormalTok{();}
\end{Highlighting}
\end{Shaded}
