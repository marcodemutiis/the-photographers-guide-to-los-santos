...
//Image circulation over online networks brings another set of forces that shapes the connection between architecture and images Instagram -\textgreater{} shapes buildings?

Games between simulating life to the details and have the space to create impossible architecture and imaginary cities
