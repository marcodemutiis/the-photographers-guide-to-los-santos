...
//1. Press the \texttt{UP\ Arrow\ Key} to take out the in-game smartphone and dial \texttt{1999578253} to activate \texttt{Director\ Mode}.
//2. On the game pause menu go to \texttt{Rockstar\ Editor} tab (last tab on the right) and select \texttt{Director\ Mode}
//3. press \texttt{M} key on PC to bring up the \texttt{Interaction\ Menu} and select \texttt{Director\ Mode}
