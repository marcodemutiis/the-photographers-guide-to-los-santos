...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{myPeds[}\DecValTok{0}\NormalTok{].}\FunctionTok{WanderAround}\NormalTok{();}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{myPeds[}\DecValTok{2}\NormalTok{].}\FunctionTok{FightAgainst}\NormalTok{(myPeds[}\DecValTok{3}\NormalTok{]);}
\NormalTok{myPeds[}\DecValTok{3}\NormalTok{].}\FunctionTok{FightAgainst}\NormalTok{(myPeds[}\DecValTok{2}\NormalTok{]);}
\end{Highlighting}
\end{Shaded}
...
We can control the time and the light for our shots to the second in GTA V. We can specify the exact time of the day with the native function \texttt{SET\_CLOCK\_TIME}, followed by hour, minute and second.
