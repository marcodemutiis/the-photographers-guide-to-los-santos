...
\NormalTok{\{}
    \KeywordTok{public} \KeywordTok{class}\NormalTok{ moddingTutorial : Script}
\NormalTok{    \{}
        \DataTypeTok{bool}\NormalTok{ botOn = }\KeywordTok{false}\NormalTok{;}
...
\NormalTok{                Random rndWandering = }\KeywordTok{new} \FunctionTok{Random}\NormalTok{();}
                \DataTypeTok{int}\NormalTok{ Wandering = (}\DataTypeTok{int}\NormalTok{)rndWandering.}\FunctionTok{Next}\NormalTok{(}\DecValTok{20}\NormalTok{, }\DecValTok{50}\NormalTok{);}
                \FunctionTok{Wait}\NormalTok{(Wandering*}\DecValTok{1000}\NormalTok{);}
\NormalTok{                Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{.}\FunctionTok{Task}\NormalTok{.}\FunctionTok{ClearAll}\NormalTok{();}
                \FunctionTok{Wait}\NormalTok{(}\DecValTok{500}\NormalTok{);}

                \CommentTok{//^TO DO: teleport character if it's in the water}
                \KeywordTok{if}\NormalTok{ (Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{.}\FunctionTok{IsSwimming}\NormalTok{)}\CommentTok{//(Function.Call<bool>(Hash.IS_PED_SWIMMING, Game.Player.Character))}
\NormalTok{                \{}
                    \CommentTok{//teleport}
\NormalTok{                \}}
...
\NormalTok{                    UI.}\FunctionTok{ShowSubtitle}\NormalTok{(}\StringTok{"close app"}\NormalTok{, }\DecValTok{1000}\NormalTok{);}
                    \FunctionTok{keyOut}\NormalTok{(}\BaseNTok{0x01}\NormalTok{, }\DecValTok{500}\NormalTok{); }\CommentTok{//ESC}
                    \FunctionTok{Wait}\NormalTok{(}\DecValTok{2000}\NormalTok{);}
...
\NormalTok{                    UI.}\FunctionTok{ShowSubtitle}\NormalTok{(}\StringTok{"put away phone"}\NormalTok{, }\DecValTok{1000}\NormalTok{);}
                    ...
                    \FunctionTok{Wait}\NormalTok{(}\DecValTok{4000}\NormalTok{);}
\NormalTok{            \}}
\NormalTok{        \}}
...
\NormalTok{              UI.}\FunctionTok{ShowSubtitle}\NormalTok{($}\StringTok{"GTA V Photographer Bot is \{(botOn ? "}\NormalTok{~g~ON}\StringTok{" : "}\NormalTok{~r~OFF}\StringTok{")\}"}\NormalTok{, }\DecValTok{3000}\NormalTok{);}
\NormalTok{           \}}
\NormalTok{        \}}
\NormalTok{    \}}
\NormalTok{\}}
