...
Yet the game is not just a simulation of the physical space and realism is more of an added visual effect that is still subordinate to gameplay. The architecture in the game is still part of an environment to be played, and not just seen. In the case of Assassin's Creed Unity, this is especially true, as the game mechanics focus on the character abliity to climb over the roofs and buildings of the city.
