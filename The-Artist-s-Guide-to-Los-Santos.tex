...
\emph{The Continuous City} is a photographic series by British artist, writer and game designer Gareth Damian Martin which explores the role of architecture in computer games. Comprising of 200 photographs of game buildings and infrastructure, \emph{The Continuous City} is created through analog 35mm black and white film photographs of games projected via a DLP projector. Working between the digital urban space and the analogue tradition of architecture photography, the artist creates ambiguous spaces that are subtly surreal. THrough the double mediation of simulated urban space in the game and the phtoographic representation, \emph{The Continuous City} reveals architecture as an ultimately virtual image and an illusion that confounds the physical experience of the urban space. The project moves through several different games to create a constantly changing space that is rendered homogenous through the black and white, high ISO grainy film photographs. It destabilizes the viewer who encounters images familiar at first glance, only to be confronted -- upon closer inspeciton -- with city landscapes that are imaginary. Finally the project is also a nod to Italo Calvino's \emph{Invisible Cities}, another attempt to explore the urban space through fictional and fantastic scenes just like the impossible collective architecture of videogame cities.
