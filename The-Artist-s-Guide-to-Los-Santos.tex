...
Try to kill one of the \texttt{Ped} NPCs you created by using the \texttt{Kill()} function (Sorry I know how cruel it sounds to kill an entity you just gave birth to, but we have no choice as we have not learnt how to give them tasks yet).
