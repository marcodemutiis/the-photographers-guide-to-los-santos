...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Function.}\FunctionTok{Call}\NormalTok{(Hash._PLAY_AMBIENT_SPEECH1, Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{, }\StringTok{"GENERIC_CURSE_MED"}\NormalTok{, }\StringTok{"SPEECH_PARAMS_FORCE"}\NormalTok{, }\DecValTok{1}\NormalTok{);}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Function.}\FunctionTok{Call}\NormalTok{(Hash._PLAY_AMBIENT_SPEECH_WITH_VOICE, Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{, }\StringTok{"DODGE"}\NormalTok{, }\StringTok{"a_f_y_beach_01_white_full_01"}\NormalTok{, }\StringTok{"Speech_Params_Standard"}\NormalTok{, }\DecValTok{0}\NormalTok{);}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{//add this on top: }
\KeywordTok{using}\NormalTok{ System.}\FunctionTok{Media}\NormalTok{;}

\CommentTok{//Or better instantiate global variable}
\NormalTok{SoundPlayer player = }\KeywordTok{new} \FunctionTok{SoundPlayer}\NormalTok{(}\StringTok{"./scripts/Eran_N.wav"}\NormalTok{);}
\CommentTok{//and on key press}
\NormalTok{player.}\FunctionTok{Load}\NormalTok{();}
\NormalTok{player.}\FunctionTok{Play}\NormalTok{();}

\CommentTok{//on another key we can stop the plaback}
