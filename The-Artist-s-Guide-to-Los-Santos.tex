...
\item
  Run GTA V and press \texttt{F8} to bring up the Menyoo Trainer menu. From there you can control many of the functions we are learning to script, including character models, animations, and teleporting. Scripting will always give you more accurate control of what you can achieve, but a trainer mod is very useful in showing the possibilities. Finally, menyoo as a creative tool can be combined with custom scripts, Scene Director and Rockstar Editor.
\end{itemize}
