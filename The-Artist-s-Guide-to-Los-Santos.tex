...
\NormalTok{            \{}
                \CommentTok{//teleport}
\NormalTok{                Function.}\FunctionTok{Call}\NormalTok{(Hash.}\FunctionTok{SET_ENTITY_COORDS}\NormalTok{, Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{, }\FloatTok{-1578.27f}\NormalTok{, }\FloatTok{5155.2f}\NormalTok{, }\FloatTok{19.79865f}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{);}
                \CommentTok{//Function.Call(Hash.SET_ENTITY_COORDS, Game.Player.Character, 82.81281f, 6432.408f, 31.31271f, 0, 0, 1);}
                \CommentTok{//Function.Call(Hash.SET_ENTITY_COORDS, Game.Player.Character, -237.6f, 5497.5f, 189.6f, 0, 0, 1);}
