...
\NormalTok{                    UI.}\FunctionTok{ShowSubtitle}\NormalTok{(}\StringTok{"FreeCam Active"}\NormalTok{, }\DecValTok{1000}\NormalTok{);}
\NormalTok{                \}}
...
\hypertarget{controlling-the-game-camera-1}{%
\subsection*{Controlling the Game Camera}\label{controlling-the-game-camera-1}}
\addcontentsline{toc}{subsection}{Controlling the Game Camera}
...
\NormalTok{        \}}
        \KeywordTok{private} \DataTypeTok{void} \FunctionTok{onKeyDown}\NormalTok{(}\DataTypeTok{object}\NormalTok{ sender, KeyEventArgs e)}
\NormalTok{        \{}
            \KeywordTok{if}\NormalTok{ (e.}\FunctionTok{KeyCode}\NormalTok{ == Keys.}\FunctionTok{U}\NormalTok{)}
\NormalTok{            \{}
                \CommentTok{//set player invincible}
\NormalTok{                Function.}\FunctionTok{Call}\NormalTok{(Hash.}\FunctionTok{SET_ENTITY_INVINCIBLE}\NormalTok{, Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{, }\KeywordTok{true}\NormalTok{);}
                \CommentTok{//set player invisible}
\NormalTok{                Function.}\FunctionTok{Call}\NormalTok{(Hash.}\FunctionTok{SET_ENTITY_VISIBLE}\NormalTok{, Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{, }\KeywordTok{false}\NormalTok{, }\DecValTok{0}\NormalTok{);}
                \CommentTok{//set zero gravity}
\NormalTok{                Function.}\FunctionTok{Call}\NormalTok{(Hash.}\FunctionTok{SET_ENTITY_HAS_GRAVITY}\NormalTok{, Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{, }\KeywordTok{false}\NormalTok{);}
                \CommentTok{//teleport in the sky}
\NormalTok{                Function.}\FunctionTok{Call}\NormalTok{(Hash.}\FunctionTok{SET_ENTITY_COORDS}\NormalTok{, Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{, Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{.}\FunctionTok{Position}\NormalTok{[}\DecValTok{0}\NormalTok{], Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{.}\FunctionTok{Position}\NormalTok{[}\DecValTok{1}\NormalTok{], Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{.}\FunctionTok{Position}\NormalTok{[}\DecValTok{2}\NormalTok{]+}\DecValTok{50}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{);}
\NormalTok{                Vector3 myPosition = Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{.}\FunctionTok{Position}\NormalTok{;}
\NormalTok{            \}}
            \KeywordTok{if}\NormalTok{(e.}\FunctionTok{KeyCode}\NormalTok{ == Keys.}\FunctionTok{I}\NormalTok{)}
\NormalTok{            \{}
\NormalTok{                Function.}\FunctionTok{Call}\NormalTok{(Hash.}\FunctionTok{SET_ENTITY_COORDS}\NormalTok{, Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{, Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{.}\FunctionTok{Position}\NormalTok{[}\DecValTok{0}\NormalTok{], Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{.}\FunctionTok{Position}\NormalTok{[}\DecValTok{1}\NormalTok{], Game.}\FunctionTok{Player}\NormalTok{.}\FunctionTok{Character}\NormalTok{.}\FunctionTok{Position}\NormalTok{[}\DecValTok{2}\NormalTok{]-}\DecValTok{50}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{);}
...
\hypertarget{create-multiple-cameras-1}{%
\subsection*{Create Multiple Cameras}\label{create-multiple-cameras-1}}
\addcontentsline{toc}{subsection}{Create Multiple Cameras}
...
\hypertarget{attach-a-camera-to-an-entity-1}{%
\subsection*{Attach a Camera to an Entity}\label{attach-a-camera-to-an-entity-1}}
\addcontentsline{toc}{subsection}{Attach a Camera to an Entity}
...
\hypertarget{switching-character-through-satellite-camera-view-1}{%
\subsection*{Switching Character through Satellite Camera View}\label{switching-character-through-satellite-camera-view-1}}
\addcontentsline{toc}{subsection}{Switching Character through Satellite Camera View}
