    ...
    public class moddingTutorial : Script
    {
        ...
        private void onTick(object sender, EventArgs e) //this function gets executed continuously 
        {
            if(botOn)
            {
                ...
                int Wandering = (int)rndWandering.Next(20, 50);
                Wait(Wandering*1000);
                Game.Player.Character.Task.ClearAll();
                Wait(500);

                //^TO DO: teleport character if it's in the water
                if (Game.Player.Character.IsSwimming)//(Function.Call<bool>(Hash.IS_PED_SWIMMING, Game.Player.Character))
                {
                    //teleport
                }
        ...
        private void onKeyUp(object sender, KeyEventArgs e)
        {
           if (e.KeyCode == Keys.H)
           {
              ...
              botOn = !botOn;
              UI.ShowSubtitle($"GTA V Photographer Bot is {(botOn ? "~g~ON" : "~r~OFF")}", 3000);
           }
        }
    }
}
