...
namespace moddingTutorial
{
    public class moddingTutorial : Script
    {
        ...
        private void checkDanger()
        {
            ...
            {
                //teleport
                Function.Call(Hash.SET_ENTITY_COORDS, Game.Player.Character, -1578.27f, 5155.2f, 19.79865f, 0, 0, 1);
                //Function.Call(Hash.SET_ENTITY_COORDS, Game.Player.Character, 82.81281f, 6432.408f, 31.31271f, 0, 0, 1);
                //Function.Call(Hash.SET_ENTITY_COORDS, Game.Player.Character, -237.6f, 5497.5f, 189.6f, 0, 0, 1);
                UI.Notify("Teleport");
            }
        }
