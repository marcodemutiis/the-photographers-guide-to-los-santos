...
We can control the time and the light for our shots to the second in GTA V. We can specify the exact time of the day with the native function ```SET_CLOCK_TIME```, followed by hour, minute and second.
