...
```cs
Prop MyProp = World.CreateProp("xm_prop_x17_sub_alarm_lamp", Game.Player.Character.GetOffsetInWorldCoords(new Vector3(0, 3, -3)), true, false);
```
...
```{r fig.align='left', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), fig.link=''}
knitr::include_graphics('assets/scriptingGifs/reshade.gif', dpi = NA)
```
