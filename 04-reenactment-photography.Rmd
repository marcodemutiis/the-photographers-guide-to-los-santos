...
The Camera function allows players to position and control the game camera more freely, with less restrictions than the camera options in game play. There is an exception 
...
Note: gameplay in first-person perspective cannot have camera edits made in the editor, and certain Story Mode missions and Random Events will not allow recording at all.
