...
[Native functions](https://nitanmarcel.github.io/shvdn-docs.github.io/namespace_g_t_a_1_1_native.html#a84977424e1cb7b6f1c2902770bf9ad2d) are called by using ```Function.Call``` followed by their corresponding Hash and parameters. The native function for teleporting  is ```Function.Call(Hash.SET_ENTITY_COORDS, Ped ped, X, Y, Z, 0, 0, 1);```
